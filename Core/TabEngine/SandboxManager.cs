...
public sealed class SandboxManager
{
    ...
    private void LoadProfiles()
    {
        ...
        try
        {
            ...
            var profiles = System.Text.Json.JsonSerializer.Deserialize<List<SandboxProfile>>(json);
    ...
    {
        var cards = string.Join("", _profiles.Select(p =>
        {
            var badge = p.IsDefault ? """<span class="badge default">Default</span>""" : "";
            return $"""
                <div class="profile">
